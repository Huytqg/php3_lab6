...
<div class="container mt-5">  
    <h1 class="text-center m-4">Danh sách tài khoản</h1>  
                ...
                <tr>  
                    ...
                    <td>  
                        <form action="{{ route('users.toggle-status', $user) }}" method="post" style="display: inline;">  
                            @csrf  
                            <button onclick="return confirm('Bạn có chắc chắn muốn thay đổi trạng thái?')" type="submit" class="btn btn-warning text-white">  
    ...
    <div class="mt-5">  
        <a href="{{ route('post.index') }}" class="btn btn-success">Quay lại</a>     
    </div>
